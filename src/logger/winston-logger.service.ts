...
export class WinstonLoggerService implements LoggerService {
  private logger;
  private serviceName = 'du-api';
  private systemName = 'do-utilization';
  ...
  constructor(
    ...
    const config = {
      ...
      local: !(this.aws.cloudWatch.show === 'enable' && this.aws?.accessKeyId), // Optional. If set to true, the log will fall back to the standard 'console.log'.
    };
